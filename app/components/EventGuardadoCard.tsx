...
import { CalendarDays, Clock, MapPin as MapPinStroke, Users2, Trash2 } from "lucide-react";
...
export default function EventCard({
    ...
    className?: string;
    showMap?: boolean;
    usuarioId: number; // 🔹 se requiere para eliminar
}) {
    const e = event;
  ...
  p-4 transition-transform duration-300 cursor-pointer ${className}`}
            >
