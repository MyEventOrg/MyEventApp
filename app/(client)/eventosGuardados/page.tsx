...
import eventoGuardadoApi, { EventoGuardado } from "../../api/eventoGuardado";
import EventGuardadoCard from "../../components/EventGuardadoCard";
...
export default function EventosGuardados() {
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                const resp = await eventoGuardadoApi.getEventosGuardados(user.usuario_id);
                if (!activo) return;
        ...
        <>
...

            {
                loading ? (
                    ...
                    <p className="text-center text-gray-500">No has guardado ningun evento</p>
                ) : (
